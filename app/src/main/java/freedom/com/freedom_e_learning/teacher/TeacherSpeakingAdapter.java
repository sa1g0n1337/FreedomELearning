...
public class TeacherSpeakingAdapter extends RecyclerView.Adapter<TeacherSpeakingAdapter.RecyclerViewHolder> {
    Context context;
    String topic;
    ArrayList<User> users = new ArrayList<>();

    public TeacherSpeakingAdapter(Context context, String mUserID) {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder recyclerViewHolder, final int position) {
        ...
        recyclerViewHolder.cv_User.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, TeacherSpeakingDetailActivity.class);
